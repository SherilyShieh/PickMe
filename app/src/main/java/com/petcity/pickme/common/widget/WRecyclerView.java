...
/**
 * Used 自定义RecyclerView，在不改动 RecyclerView 原有 adapter 的情况下，使其拥有加载更多功能和自定义底部视图。
 * 参考资料：https://github.com/nukc/LoadMoreWrapper
 * @touch执行顺序：dispatchTouchEvent（Action_down）——onScrollStateChanged==RecyclerView.SCROLL_STATE_DRAGGING[1]——【onTouchEvent（Action_move）——onScrolled】循环——onTouchEvent（Action_up）——onScrollStateChanged==RecyclerView.SCROLL_STATE_IDLE[0]
 */
